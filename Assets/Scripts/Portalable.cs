...
public class Portalable : MonoBehaviour
{
	...
	public void PortalOpen(Vector3 hitPoint, Vector3 hitNormal)
	{
		Mesh mesh = new Mesh();
		...
		Matrix4x4 translateMatrix = Matrix4x4.Translate(transform.worldToLocalMatrix.MultiplyPoint(hitPoint));
