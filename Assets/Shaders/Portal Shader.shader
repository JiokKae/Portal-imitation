...
Shader "ASE/PortalShader"
{
	...
	SubShader
	{
		...
		void surf( Input i , inout SurfaceOutput o )
		{
			...
			float4 lerpResult39 = lerp( ( 2.0 * ( tex2D( _MainTexture, ( float4( uv_TexCoord162, 0.0 , 0.0 ) + tex2DNode164 + float4( float2( 0,0.66 ), 0.0 , 0.0 ) ).rg ) * tex2D( _MainTexture, ( float4( uv_TexCoord163, 0.0 , 0.0 ) + tex2DNode164 ).rg ) ) * _PortalColor ) , tex2DNode1 , _Open);
			float4 ifLocalVar130 = 0;
			if( dotResult137 > 0.48 )
				ifLocalVar130 = tex2DNode1;
			else if( dotResult137 < 0.48 )
				ifLocalVar130 = ( lerpResult39 + ( pow( length( ase_vertex3Pos ) , _Exp ) * _te * _PortalColor ) );
...
/*ASEBEGIN
Version=18800
67;30;1657;878;-1799.941;-1042.132;1;True;False
...
Node;AmplifyShaderEditor.ColorNode;38;621.8806,96.91333;Inherit;False;Property;_PortalColor;PortalColor;0;1;[HDR];Create;True;0;0;0;False;0;False;1.498039,0.9098039,0.2745098,0;0.1633856,0.4071153,1.356811,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.TexturePropertyNode;5;111.3483,1039.531;Inherit;True;Property;_MainTex;MainTex;4;0;Create;True;0;0;0;False;0;False;None;e28dc97a9541e3642a48c0e3886688c5;False;white;Auto;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
...
Node;AmplifyShaderEditor.RangedFloatNode;40;1090.644,863.097;Inherit;False;Property;_Open;Open;5;0;Create;True;0;0;0;False;0;False;0;1;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleAddOpNode;188;2078.568,946.2456;Inherit;True;2;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.TFHCIf;217;2500.166,1500.238;Inherit;False;6;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;1;False;3;FLOAT;0;False;4;FLOAT;0;False;5;FLOAT;0.01;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.ConditionalIfNode;206;2790.165,1488.359;Inherit;False;False;5;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;4;FLOAT;0;False;1;FLOAT;0
...
ASEEND*/
//CHKSM=1645A78A7FD3083EA8F60D0C647D6775E3F7A9ED